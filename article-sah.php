...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Chivo|Fira+Sans+Condensed|Magra|Montserrat|PT+Sans+Narrow|Palanquin+Dark|Slabo+27px|Titillium+Web|Rubik" rel="stylesheet">
</head>
...
<div class="campusmenu-body">
    ...
    <div class="space-break2"></div>
        ...
        <div class="article-introdetails">
            <h1 id="article-title">The Fall Of A Sparrow</h1>
            <ul id="article-info-inline"><li>April 9th 2017</li><li>14 Activities</li></ul>
        </div>
        ...
        <div class="article-content-body">
            ...
            <div class="row">
                    ...
                    <div class="col-md-3">
                            <div id="articledetails-anchor"></div>
                            <div class="article-artist-details" id="articledetails-stick">
                                <img style="width:200px;" alt="TenToesDown Canadian music artist SafeAsHouses" class="img-circle img-responsive" id="articledetfeatimg" src="../img/artists/music/safeashouses.png">
                                <p id="article-leftmenu-artist">Safe As Houses</p>
                                <p id ="article-leftmenu-date">April 9th, 2017</p>
                                <p id ="article-leftmenu-tags"><span id="ttdFiltertag">Music</span><span id="ttdFiltertag">Indie Rock</span></p>
                            </div>
                ...
                <div class="col-md-9">
                 <div class="article-content">
                     <p id="article-listenandread">Listen while you read...</p>

                        <iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/212437968&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"></iframe>
...
<hr>
    <div class="article-featsc-embed">
        <iframe width="80%" height="450" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/289930386&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"></iframe>
    </div>
    <br><br>
