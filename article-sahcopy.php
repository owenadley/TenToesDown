...
<div class="campusmenu-body">
    ...
    <div class="space-break2"></div>
        ...
        <div class="article-content-body">
            <div class="col-md-3">
                <div class="article-artist-details">
                    <img style="width:150px;" alt="TenToesDown Canadian music artist SafeAsHouses" class="img-circle img-responsive" src="../img/artists/music/safeashouses.png"><br><p id="article-artist-text">Safe As Houses</p>
                </div>
            </div>
...
<hr>
    <div class="article-featsc-embed">
        <iframe width="50%" height="450" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/289930386&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"></iframe>
    </div>
    <br><br>
